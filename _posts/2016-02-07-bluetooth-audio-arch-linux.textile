...
As always, the "arch wiki":https://wiki.archlinux.org/ was _extremely_ helpful.
Because arch maintainers create such good documentation, it was really painless to stream audio from my laptop to the bluetooth radio.
